  ...
  return (
    <>
      ...
      <main>
        ...
        <div className='tools flex flex-wrap py-14 gap-x-4'>
      ...
      <main className='my-10'>
        ...
        <div className='card-list flex justify-center flex-wrap gap-x-4'>
          {Array.from({ length: 4 }, (_, i) => (
            <Fragment key={i}>
              <div className='card relative flex flex-col gap-y-4 justify-between items-center border border-gray-300 p-8 rounded-xl'>
                <div className='card-top flex flex-col items-center gap-y-4'>
